...
// 윤년이란? 지구가 태양을 한바퀴도는데 걸리는 시간이 365일과 1/4만큼 소요 되기 때문에
// 일반적으로 4년에 한번씩 2월 29일이 존재 (366일)
// 윤년의 규칙
...
//            System.out.println(year + "년은 윤년이 아닙니다");
        // }
        // String name ? year % 100 == 0 || year % 400 == 0

        String result = (year % 4 == 0 && year % 100 != 0 || year % 400 == 0) ? year + "년은 윤년입니다" : year + "년은 윤년이 아닙니다";
