...
public class MemberInfo {
    // 관리해야 할 필드 추가
    private String name; // private는 클래스 내부에서만 접근을 허용하는 접근제한자
    private int age;
    private char gender;
    private int jobs;
    ...
    // 성별을 입력받아 성별이 남성이면 정수 값 1을 반환하고, 여성이면 정수 값이 2를 반환
    ...
    public void setJobs() {
        while (true) {
            ...
            jobs = sc.nextInt();
            if(jobs > 0 && jobs < 5) return; // return은 해당 메소드를 호출한 곳으로 반환값을 반환하고 종료
