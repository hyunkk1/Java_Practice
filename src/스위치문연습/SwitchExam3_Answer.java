...
public class SwitchExam3_Answer {
    public static void main(String[] args) {
        ...
        String month = date.substring(4, 6); // 인덱스는 0부터 시작, 두번째 오는 값은 미만. 그러므로 달에 해당하는 4와 6입력 5번째줄 참고.
        ...
        System.out.println("아래의 일정으로 " + title + "진행하고자 하오니 오셔서 자리를 빛내주시기 바랍니다.");
